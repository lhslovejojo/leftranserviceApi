...
public class UserResponse implements Serializable {
	...
	public String toString() {
		return "UserResponse [exchangeId=" + exchangeId + ", serialNo=" + serialNo + ", memCode=" + memCode
				+ ", exchangeMemberStatus=" + exchangeMemberStatus + ", fullName=" + fullName + ", shortName="
				+ shortName + ", enFullName=" + enFullName + ", enShortName=" + enShortName + ", gender=" + gender
				+ ", nationality=" + nationality + ", idKind=" + idKind + ", idNo=" + idNo + ", tel=" + tel
				+ ", upMemCode=" + upMemCode + ", brokerCode=" + brokerCode + ", memCodeClear=" + memCodeClear
				+ ", fundAccountClear=" + fundAccountClear + ", memberMainType=" + memberMainType + ", memberType="
				+ memberType + ", exchangeFundAccount=" + exchangeFundAccount + ", tradeAccount=" + tradeAccount
				+ ", legalPerson=" + legalPerson + ", businessCert=" + businessCert + ", orgCode=" + orgCode
				+ ", taxCert=" + taxCert + ", taxCertType=" + taxCertType + ", regAddr=" + regAddr + ", comAddr="
				+ comAddr + ", contactName=" + contactName + ", contactTel=" + contactTel + ", contactFax=" + contactFax
				+ ", contactEmail=" + contactEmail + ", balanceResponse=" + balanceResponse + ",busiDate=" + busiDate
				+ "]";
	}
